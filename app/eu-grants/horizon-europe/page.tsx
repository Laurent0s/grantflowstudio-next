        ...
        <div className="container mx-auto px-4 mb-16">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground">
              The programme facilitates collaboration and strengthens the impact of research and innovation in developing, 
              supporting and implementing EU policies while tackling global challenges. It supports creating and better 
              dispersing of high-quality knowledge and technologies.
            </p>
          </div>
        </div>
